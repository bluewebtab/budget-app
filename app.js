...
//    data saves id, description, and value
    ...
    return {
        addItem: function (type, des, val) {
            ...
            //Create new ID
            //You make the ID by getting the length and minus that with one then you add +1 to go to the next id.
            //ID = last ID +1
//            the length starts with 0 because there is nothing in the array.
...
var UIController = (function () {
    ...
    return {
        ...
        clearFields: function () {
            ...
            //this focuses on the the description box
            fieldsArr[0].focus();
        },
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    if(itemID){
        ...
        //you will contain the type
        type = splitID[0];
        //you will contain the id
        //parseInt allows the string to become an integer
